...
(cl:defmethod cl:initialize-instance :after ((m <Context-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Context-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r_chatbot-srv:<Context-request> is deprecated: use r_chatbot-srv:Context-request instead.")))

(cl:ensure-generic-function 'input-val :lambda-list '(m))
(cl:defmethod input-val ((m <Context-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r_chatbot-srv:input-val is deprecated.  Use r_chatbot-srv:input instead.")
  (input m))
...
(cl:defmethod cl:initialize-instance :after ((m <Context-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Context-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r_chatbot-srv:<Context-response> is deprecated: use r_chatbot-srv:Context-response instead.")))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <Context-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r_chatbot-srv:response-val is deprecated.  Use r_chatbot-srv:response instead.")
  (response m))

(cl:ensure-generic-function 'correlation-val :lambda-list '(m))
(cl:defmethod correlation-val ((m <Context-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r_chatbot-srv:correlation-val is deprecated.  Use r_chatbot-srv:correlation instead.")
  (correlation m))
