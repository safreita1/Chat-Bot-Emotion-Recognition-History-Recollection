...
(cl:defmethod cl:initialize-instance :after ((m <FaceRecognize-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FaceRecognize-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r_chatbot-srv:<FaceRecognize-request> is deprecated: use r_chatbot-srv:FaceRecognize-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FaceRecognize-request>)))
  ...
  "r_chatbot/FaceRecognizeRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FaceRecognize-request)))
  "Returns string type for a service object of type 'FaceRecognize-request"
  "r_chatbot/FaceRecognizeRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <FaceRecognize-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FaceRecognize-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r_chatbot-srv:<FaceRecognize-response> is deprecated: use r_chatbot-srv:FaceRecognize-response instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <FaceRecognize-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r_chatbot-srv:id-val is deprecated.  Use r_chatbot-srv:id instead.")
  (id m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <FaceRecognize-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r_chatbot-srv:name-val is deprecated.  Use r_chatbot-srv:name instead.")
  (name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FaceRecognize-response>)))
  ...
  "r_chatbot/FaceRecognizeResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FaceRecognize-response)))
  "Returns string type for a service object of type 'FaceRecognize-response"
  "r_chatbot/FaceRecognizeResponse")
