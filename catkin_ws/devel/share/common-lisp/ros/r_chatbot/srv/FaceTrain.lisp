...
(cl:defmethod cl:initialize-instance :after ((m <FaceTrain-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FaceTrain-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r_chatbot-srv:<FaceTrain-request> is deprecated: use r_chatbot-srv:FaceTrain-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <FaceTrain-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FaceTrain-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r_chatbot-srv:<FaceTrain-response> is deprecated: use r_chatbot-srv:FaceTrain-response instead.")))
